...
while(true)
{
		System.out.println("####  welcome to Annotation App#####");
		System.out.println("####1 ) Add customer App     #####");
		System.out.println("####2 ) update customer      #####");
		System.out.println("####4 ) Delete customer      #####");
		System.out.println("####5 ) Fetch all customer   #####");
		System.out.println("####6 ) Exit                 #####");
		System.out.println("####7 )search all customer greater than billamount                 #####");
	...
	if(choice==8)
	{
		...
		System.out.println("please enter the bill amount ");
		int billAmount = scanner.nextInt();
		System.out.println("please enter customer address to search");
